"""
Analysis of Monte Carlo Dropout Results for Lane Change Prediction
This script analyzes MC dropout reliability scores using revised definitions
...
# File path to the Monte Carlo dropout results
FILE_PATH = 'real_time_mc_dropout_results.pkl'
...
def plot_threshold_metrics(threshold_results, output_prefix='mc_dropout'):
    """
    ...
    """
    # Set up figure with one subplot
...
def plot_reliability_distributions(combined_data, output_prefix='mc_dropout'):
    """
...
def generate_trajectory_confusion_matrix(data, output_prefix='mc_dropout'):
    """
...
def create_summary_table(threshold_results):
    ...
    # Save to CSV
    summary_df.to_csv(f'mc_dropout_summary_table.csv', index=False)
    print(f"Saved summary table to mc_dropout_summary_table.csv")

    return formatted_df
def plot_threshold_metrics_improved(threshold_results, output_prefix='mc_dropout'):
    """
    Create a publication-quality plot showing how different metrics
    change with reliability thresholds using the updated definitions
...
def plot_threshold_metrics_color_improved(threshold_results, output_prefix='mc_dropout'):
    """
...
def main():
    ...
    plot_threshold_metrics_color_improved(threshold_results, 'mc_dropout')
    ...
    threshold_results.to_csv('mc_dropout_threshold_analysis_results.csv', index=False)
